...
async def main():
    ...
    runner = Runner(app_name="PlannerApp", agent=agent, session_service=service, auto_create_session=True)
    
    msg = types.Content(role="user", parts=[types.Part(text="Output the implementation plan for hello.py with instruction 'print hello world' and context 'entry point'.")])
