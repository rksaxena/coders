...
from src.swarm_coder.core.models import TaskStatus
from src.swarm_coder.cli.workspace import setup_workspace, load_or_resume_plan
from src.swarm_coder.cli.phases import (
    run_planning_phase,
    run_execution_phase,
    run_reviewer_phase,
)
...
async def async_main() -> None:
    ...
    logger.info("--- Swarm Coding Agents Interactive CLI ---")
    ...
    while plan:
        has_pending_tasks = any(
            task.status != TaskStatus.COMPLETED for task in plan.tasks
        )
